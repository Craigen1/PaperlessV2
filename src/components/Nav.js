    ...
    <div>
      <div className="drawer   z-50">
        ...
        <div className="drawer-content">
          ...
          <label
            htmlFor="drawer"
            className="btn btn- drawer-button  text-center "
          >
            <div className="mt-1">
              <BurgerBtn />
            </div>
        ...
        <div className="drawer-side">
          ...
          ></label>
          <div className="menu p-2 w-80 min-h-full bg-gray-400  ">
            {/* <div className="">
              <ul class="menu menu-xs bg-gray-400  rounded-lg max-w-xs w-full">
                <li>
                  <a>
                    <svg
