...
export function PopPOList() {
  const { PopPOListModal, setPopPOListModal, popLabel, popTitle } =
  ...
  return (
    <Transition appear show={PopPOListModal} as={Fragment}>
      <Dialog as="div" className="relative z-50" onClose={closeModalx}>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="w-full  py-4 max-w-md transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all z-50">
                <Dialog.Title
                  as="h3"
