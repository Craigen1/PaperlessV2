...
export default function PalletingPrint(p) {
  ...
  function TimeStamp() {
    ...
    return (
      <>
        <p>{formatDate(z, "yyyy-MM-dd HH:mm")}</p>
      </>
    );
  }
  const compUpperLeft = [
  ...
  return (
    <div className="relative     px-6 pt-4">
      {/* <DefButton
        ...
        type="5"
      /> */}
      <div className="font-bold text-2xl">PALLET MARKER</div>
      ...
      <div className="w-full   flex h-5 justify-between   font-semibold text-sm">
        <p>LG-01 REV.8(06/19/24)</p>
        <p>
          <TimeStamp />
        </p>
        {/* LG-01-Rev.7 () */}
      ...
      <div className="w-[200px]  absolute top-[70px] right-4">
        <table className="border border-black  w-full ">
          <tr>
            ...
            <td className="border border-black  text-center">FROM</td>
            <td className="border border-black  text-center">TO</td>
          </tr>
          <tr>
      ...
      <div className="width: i.widthTitle text-center ">
        This form is computer generated document hence all information above is
        correct and validated. No signature required.
        {/* LG-01-Rev.7 () */}
      </div>
    </div>
  );
